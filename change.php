...
if(isset($_POST['submit'])){
    ...
    if(is_array($row) && !empty($row)){
        ...
        echo "<div class='message'><p>Erreur de changement de compte.</p></div><br>";
    }
}
?>
...
<head>
    ...
    <title>Changer de compte</title>
</head>
<body>
    <div class="container">
        <div class="box form-box">
            <header>Changer de compte</header>
            <form action="" method="post">
                ...
                <div class="field">
                    <input type="submit" name="submit" value="Changer de compte" class="btn" required>
                </div>
                <div class="link">
